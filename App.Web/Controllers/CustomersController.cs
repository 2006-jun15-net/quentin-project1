...
namespace App.Web
{
    public class CustomersController : Controller
    {
        ...
        {
            var myDBContext = _context.Customer.Include(c => c.DefaultLocation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,DefaultLocationId")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
